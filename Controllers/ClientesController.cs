...
namespace CrudCliente.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Email,Endereço,Telefone")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Email,Endereço,Telefone")] Cliente cliente)
        {
            if (id != cliente.Id)
            {
                return NotFound();
